...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$projectRoot\backend'; Write-Host 'Starting Spring Boot Backend...' -ForegroundColor Cyan; mvn spring-boot:run"
...
Write-Host "✅ Fullstack environment launched successfully!" -ForegroundColor BrightGreen
